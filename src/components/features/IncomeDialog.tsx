...
import { Loader2, ArrowUpCircle, CalendarIcon, IndianRupee } from 'lucide-react';
...
export function IncomeDialog({ open, onOpenChange, onSuccess }: IncomeDialogProps) {
  const { user } = useAuth();
  ...
  const { accounts, transactions, incomeCategories } = useTransactionStore();
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[420px] bg-card/95 backdrop-blur-2xl border-emerald-500/20 shadow-2xl rounded-3xl overflow-hidden p-0 gap-0">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <DialogDescription className="text-xs text-muted-foreground/80 text-left mt-0.5">
                  Record a new payment to your agency.
                </DialogDescription>
              </div>
            </div>
          </DialogHeader>

          <form id="income-form" onSubmit={handleSubmit} className="space-y-5 relative z-10">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <div className="relative flex items-center justify-center">
                  ...
                  <Input 
                    ...
                    placeholder="0.00"
                    className="text-left text-2xl font-bold h-14 rounded-xl bg-background/50 border-border/60 focus-visible:ring-emerald-500/30 pl-10"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <Popover>
                  <PopoverTrigger 
                    render={
                      <Button
                        variant="outline"
                        className={cn(
                          "w-full justify-start text-left font-normal bg-background/50 border-border/60 focus-visible:ring-emerald-500/30 transition-all rounded-xl h-14 px-3",
                  ...
                  <PopoverContent className="w-auto p-0 border-emerald-500/20 shadow-xl rounded-xl" align="start">
                    <Calendar
                      mode="single"
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <Select required value={addedByName} onValueChange={(val: any) => setAddedByName(val)}>
                  <SelectTrigger className="bg-background/50 border-border/60 focus-visible:ring-emerald-500/30 transition-all rounded-xl h-14">
            ...
            <div className="space-y-1.5">
              ...
              <Select required value={selectedCategory} onValueChange={(val) => setSelectedCategory(val || '')}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="custom" className="font-semibold text-emerald-500 hover:text-emerald-600">
                    + Custom Category
                  </SelectItem>
                </SelectContent>
              </Select>
              ...
              {selectedCategory === 'custom' && (
                <div className="mt-2 animate-in fade-in slide-in-from-top-1">
                  <Input 
                    ...
                    required
                    className="bg-background/50 border-border/60 focus-visible:ring-emerald-500/30 transition-all rounded-xl h-14"
                  />
                </div>
              )}
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <textarea 
                ...
                className="flex w-full bg-background/50 border border-border/60 focus-visible:ring-emerald-500/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 ring-offset-background transition-all rounded-xl min-h-[80px] py-3 px-3 text-sm resize-none"
              />
            </div>
          </form>
        </div>
        ...
        <div className="p-6 pt-4 bg-muted/30 border-t border-border/40 mt-2">
          <Button 
            type="submit" 
            form="income-form"
            className="w-full rounded-xl h-12 text-sm font-bold tracking-wide transition-all duration-300 shadow-xl bg-emerald-600 hover:bg-emerald-500 text-white shadow-emerald-900/50 hover:shadow-emerald-600/50"
